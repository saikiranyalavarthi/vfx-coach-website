      ...
      {bannersData.map((banner, idx) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-center px-6 ">
            {/* <span className="text-6xl md:text-7xl font-bold text-[#FF991C] mt-55">
              “
            </span> */}
            <p className="text-1xl md:text-1xl lg:text-2xl font-medium max-w-4xl leading-relaxed text-white mt-76">
              {banner.quote}
            </p>
            <div className="mt-2">
              <p className="text-base md:text-xl font-semibold text-[#FF991C] ">
                {banner.author}
              </p>
              <p className="text-sm md:text-base text-[#FF991C] ">
                {banner.role}
              </p>
            </div>
          </div>
