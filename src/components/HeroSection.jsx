...
const HeroSection = () => {
  return (
    <section className="relative bg-gray-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center justify-center min-h-[auto] lg:min-h-screen">
        {/* Left Content */}
        <div className="w-full lg:w-1/2 text-center lg:text-left flex flex-col items-center lg:items-start justify-center gap-6 py-6 sm:py-8">
          ...
          <div className="flex justify-center lg:justify-start gap-3 sm:gap-4 flex-wrap">
            ...
            <button className="bg-gray-800 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-gray-700 transition">
              For Business
            </button>
          </div>
        </div>
