...
const NewsletterSection = () => {
  return (
    <section className="bg-black text-white py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto border-2 border-lime-400 rounded-2xl p-8 flex flex-col-reverse lg:flex-row items-center gap-12 bg-gray-900/10">
        {/* Left Side - Content */}
        <div className="flex-1 text-center lg:text-left">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Join thousands already learning smarter with Our VfxCoach Newsletter
          </h2>
